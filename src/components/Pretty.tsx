...
export class Pretty extends React.Component<any> {
	transitionJsonToString(jsonObj: string) {
		// 转换后的jsonObj受体对象
		var _jsonObj = null;
	...
	render() {
		return (
			<div
				...
				dangerouslySetInnerHTML={{ __html: this.formatJson(this.props.data) }}
			/>
		);
	}
}
